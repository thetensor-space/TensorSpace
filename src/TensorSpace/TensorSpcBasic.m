...
//                                   Categorical
// ==============================================================================
intrinsic SubConstructor( T::TenSpc, L::Tup ) -> TenSpc, Map
...
//    require false : "Cannot compute structure constants of tensors."; // the produced message has <source not available>...
...
intrinsic QuoConstructor( T::TenSpc, X::Tup ) -> TenSpc, Map
