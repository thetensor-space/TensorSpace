...
\\
Joshua Maglione and James B. Wilson, \emph{TensorSpace}, version 2.2, GitHub, 2019. Contributions from Peter A. Brooksbank, \url{https://github.com/algeboy/TensorSpace}. \\
\\
For AMSRefs:
\begin{verbatim}
...
{\tt SetVerbose} is a built in Magma function, but with this package, this intrinsic accepts the string \texttt{"TensorSpace"} and an integer in $\{0,1\}$. 
