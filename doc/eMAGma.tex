...
\\
Joshua Maglione and James B. Wilson, \emph{Experimental Multilinear Algebra Group}, version 1.2.3, GitHub, 2017. Contributions from Peter A. Brooksbank, \url{https://github.com/algeboy/eMAGma}. \\
\\
For AMSRefs:
\begin{code}
\bib{eMAGma}{misc}{
