...
\\
Joshua Maglione and James B. Wilson, \emph{Experimental Multilinear Algebra Group}, version 2.1, GitHub, 2019. Contributions from Peter A. Brooksbank, \url{https://github.com/algeboy/eMAGma}. \\
\\
For AMSRefs:
\begin{verbatim}
\bib{eMAGma}{misc}{
